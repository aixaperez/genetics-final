...
```{r}
# load data
data <- tbl_df(read.csv(file = "/Users/aixapz/Google Drive/690T/Group1.data", header = TRUE, sep = ''))
...
#   set.seed (1)
  # then we get SNP
  region.Snp <- genotype (hwe.ovrall[[new.names[,i]]], sep="")
  # test for HWE stratified by Regions
  hwe.region <- tapply (region.Snp, INDEX=hwe.ovrall$region,
